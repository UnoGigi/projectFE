...
const Accessori = () => {
    ...
    const getProduct = async () => {
        try {
            ...
            setProduct(data.filter((data) => data.category.toLowerCase().includes("accessori")))
            setFilteredProduct(data.filter((data) => data.category.toLowerCase().includes("accessori")))
        } catch (error) {
            console.log(error);
        }
    }
